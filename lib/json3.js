...
;(function (window) {
  ...
  var isLoader = typeof define === "function" && define.amd,
      isCommonJS = typeof exports == "object" && !exports.nodeType,
      JSON3 = isCommonJS
          // Export for CommonJS environments.
          ? exports
          // Export for web browsers and JavaScript engines.
          // Delegate to the native implementations if possible.
          : window.JSON || (window.JSON = {});

  // Delegate to the native implementations in CommonJS environments.
  if (isCommonJS && typeof JSON == "object" && JSON) {
