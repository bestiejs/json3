...
(function () {
  ...
  // Convenience aliases.
  var JSON3 = this, getClass = {}.toString, isProperty = {}.hasOwnProperty, forEach,
  ...
  // Simulate `Object#hasOwnProperty` in environments that don't support it.
  if (!isProperty || getClass.call(isProperty) != "[object Function]") {
    isProperty = (function () {
      var memo = {}, parent = memo.constructor;
      // The `__proto__` property can't be set more than once in Gecko.
      if ((memo.__proto__ = null, memo.__proto__ = { "toString": 1 }, memo).toString == 1) {
        // Safari 2.0.3 doesn't implement `hasOwnProperty`, but supports the
        // mutable `__proto__` property.
        return function (property) {
          // Capture and break the object's prototype chain. See the ES 5.1
          // spec, section 8.6.2. The parenthesized expression is necessary to
          // prevent an unsafe transformation by the Closure Compiler.
      ...
      // Use the `constructor` property to simulate `hasOwnProperty` in
      // environments that don't expose the prototype chain.
      return function (property) {
        var constructor = (this.constructor || parent).prototype;
        return property in this && !(property in constructor && this[property] === constructor[property]);
      };
    })();
  }

  // Normalizes the `for...in` iteration algorithm across environments.
  forEach = (function () {
    var size = 0, memo, property;
    ...
    for (property in memo) {
      ...
      if (isProperty.call(memo, property)) {
        size += 1;
      }
    }
    memo = null;
    ...
    if (!size) {
      ...
      return function (object, callback) {
        ...
        for (property in object) {
          ...
          if (!(isFunction && property === "prototype") && !isProperty.call(memo, property) && (memo[property] = 1) && isProperty.call(object, property)) {
            callback(property);
          }
        }
      };
    ...
    return function (object, callback) {
      ...
      if (isConstructor || isProperty.call(object, "constructor")) {
  ...
  JSON3.parse = function (source, callback) {
    ...
    return typeof callback == "function" ? walk({ "": value }, "", callback) : value;
  };
  ...
  function serialize(property, object, callback, properties, whitespace, indentation, stack) {
    ...
    if (typeof value == "object") {
      ...
      if (className == "[object Array]") {
        ...
        forEach(value, function (property) {
          if (properties && !isProperty.call(properties, property)) {
  ...
  // output.
  JSON3.stringify = function (value, filter, width) {
...
}).call(typeof exports == "object" && exports || (this.JSON3 = {}));