...
;(function (root, Module) {
  if (typeof define == "function" && define.amd) {
    ...
    Module(typeof exports == "object" && exports || this.JSON3 || (this.JSON3 = {}));
  }
})(this, function (JSON3) {
  "use strict";
  ...
  // The current version. The `JSON.Version` property is non-standard, and thus
  // provided for informational purposes only. You should not rely on it in
  // production code.
  JSON3.Version = "3.0.0-0.8.5";

  // Feature tests to determine whether the native `JSON.stringify` and `parse`
  // implementations are spec-compliant. Based on work by Ken Snyder.
  stringifySupported = typeof JSON3.stringify == "function";
  parseSupported = typeof JSON3.parse == "function";
  (function () {
    ...
    if (stringifySupported) {
      ...
      try {
        switch (false) {
          ...
          case JSON3.stringify([void 0, getClass, null]) == "[null,null,null]":
          ...
          case (toJSON = new Date(-8.64e15)).getUTCFullYear() != -271821 || JSON3.stringify(toJSON) == '"-271821-04-20T00:00:00.000Z"':
          // The milliseconds are optional in ES 5, but required in 5.1.
          case (toJSON = new Date(8.64e15)).getUTCFullYear() != 275760 || JSON3.stringify(toJSON) == '"+275760-09-13T00:00:00.000Z"':
