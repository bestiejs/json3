...
(function () {
  ...
  // Convenience aliases.
  var JSON3 = this, getClass = {}.toString, isPropertyOf = {}.hasOwnProperty, forOwn,
    ...
    if (!size) {
      ...
      return function (object, callback) {
        ...
        for (property in object) {
          ...
          if (!(isFunction && property === "prototype") && !isPropertyOf.call(memo, property) && (memo[property] = 1) && isPropertyOf.call(object, property)) {
            callback(property);
          }
        }
      };
  ...
  function serialize(property, object, callback, properties, whitespace, indentation, stack) {
    ...
    if (typeof value == "object") {
      ...
      if (className == "[object Array]") {
        ...
        forOwn(value, function (property) {
          if (properties && !isPropertyOf.call(properties, property)) {
