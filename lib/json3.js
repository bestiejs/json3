...
// If already defined, these will retain their values
var define, exports;
(function (root, Module) {
  ...
  if (exports && this.JSON) {
    exports.stringify = this.JSON.stringify;
    exports.parse = this.JSON.parse;
  } else {
    exports = this.JSON || (this.JSON = {});
  }
  // Convenience aliases.
