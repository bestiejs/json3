            ...
            switch ((charCode = source.charCodeAt(Index))) {
              ...
              case 34:
                ...
                for (value = "@", Index++; Index < length;) {
                  if ((charCode = source.charCodeAt(Index)) < 32) {
              ...
              default:
                ...
                if (charCode >= 48 && charCode <= 57) {
                  ...
                  if (charCode == 48 && ((charCode = source.charCodeAt(Index + 1)) >= 48 && charCode <= 57)) {
                  ...
                  // case-insensitive.
                  if ((charCode = source.charCodeAt(Index)) == 101 || charCode == 69) {
                    // Skip past the sign following the exponent, if one is
                    // specified.
                    if ((charCode = source.charCodeAt(++Index)) == 43 || charCode == 45) {
                      Index++;
                    }
