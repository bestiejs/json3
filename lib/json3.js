...
;(function (window) {
  ...
  var has = (function () {
    ...
    return {
      json: stringifySupported && parseSupported,
      jsonStringify: stringifySupported,
      jsonParse: parseSupported,
      bugStringCharIndex: bugStringCharIndex
    };
  ...
  if (!has.json) {
    ...
    var charIndexBuggy = has.bugStringCharIndex;
