    ...
    while (Index < length) {
      ...
      if (symbol <= " ") {
        ...
        for (value = "@", Index++; Index < length;) {
          ...
          if (symbol < " ") {
            ...
            if (symbol == "\r" || symbol == "\n") {
              ...
              position = Index + ((symbol == "\r" && source.charAt(Index + 1) == "\n") ? 2 : 1);
              value += source.slice(Index, Index = position);
        ...
        if (symbol == "0" && (source.charAt(Index + 1) == "x" || source.charAt(Index + 1) == "X")) {
          ...
          for (Index += 2; Index < length && (symbol = source.charAt(++Index), symbol >= "0" && symbol <= "9" || symbol >= "a" && symbol <= "f" || symbol >= "A" && symbol <= "F"););
        ...
        if (source.slice(Index, Index + 4) == "true") {
          ...
          for (; Index < length && (symbol = source.charAt(++Index), symbol == "$" || symbol == "_" || (symbol >= "a" && symbol <= "z") || (symbol >= "A" && symbol <= "Z") || (symbol >= "0" && symbol <= "9")););
