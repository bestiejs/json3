...
;(function (root, Module) {
  if (typeof define == "function" && define.amd) {
    ...
    Module(typeof exports == "object" && exports || root.JSON || (root.JSON = {}));
  }
})(this, function (exports) {
  // Convenience aliases.
  var getClass = {}.toString, isPropertyOf, forEach, undef,
  ...
  if (stringifySupported) {
    ...
    try {
      switch (false) {
        ...
        case exports.stringify(value) === "1":
        case exports.stringify([value]) == "[1]":
        // Prototype <= 1.6.1 serializes `[undefined]` as `"[]"` instead of
        // `"[null]"`.
        case exports.stringify([undef]) == "[null]":
        ...
        case exports.stringify([undef, getClass, null]) == "[null,null,null]":
        // Simple serialization test. FF 3.1b1 uses Unicode escape sequences
        // where character escape codes are expected (e.g., `\b` => `\u0008`).
        case exports.stringify({ "result": [value, true, false, null, "\0\b\n\f\r\t"] }) == serialized:
    ...
    forEach = function (object, callback) {
      ...
      if (!size) {
        ...
        forEach = function (object, callback) {
          ...
          if (isConstructor || isPropertyOf.call(object, (property = "constructor"))) {
            callback(property);
          }
        };
      }
