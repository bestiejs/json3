  ...
  (function () {
    ...
    if (stringifySupported) {
      try {
        ...
        switch (false) {
          // Firefox 3.1 Beta 1 and 2 incorrectly serializes string, number, and
          // boolean primitives as object literals.
          case JSON3.stringify(0) === "0":
          // FF 3.1b1, 2 will throw an error if the value is `null`, `undefined`,
          // or does not define a canonical JSON representation (this applies to
          ...
          // canonical JSON representation. This applies to objects with `toJSON`
          // properties, unless they are nested inside object or array literals.
  ...
  if (!parseSupported) {
    JSON3.parse = (function () {
      ...
      function parse(source, callback) {
        var parser = new Parser(String(source)), value = parser.get(parser.lex());
